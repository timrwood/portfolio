...
addEvent('Hometown', '1986-07', '2004-07', 'Sugar Grove, IL');
addEvent('Hometown', '2004-08', '2008-06', 'Chicago, IL');
addEvent('Hometown', '2008-07', '2010-08', 'Burbank, CA');
addEvent('Hometown', '2010-09', '2013-12', 'El Segundo, CA');
addEvent('Hometown', '2014-01', '2015-02', 'Portland, OR');
addEvent('Hometown', '2015-03', '2016-01', 'Sugar Grove, IL');
addEvent('Hometown', '2016-02', toPresent, 'Downers Grove, IL');
