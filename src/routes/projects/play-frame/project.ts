...
export default {
  ...
  coverImage,
  introImage,
  subtitle: ['Personal project', 'Fall 2024'],
  description: [
    'After six years of architecture school, working on assignments during nights and weekends, I promised my kids I would build them a tree house after graduation to make up for the lost time together. After surveying the backyard and not feeling comfortable with any of the trees, we decided to build an a-frame playhouse instead.',
