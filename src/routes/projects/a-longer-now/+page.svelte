...
<SplitView align="center" spacing="1|1">
  {#snippet left()}
    <Description>
      <p>
        How far do you think about the future? To the end of the day, the next payday, the end of
        the year, or the end of your life? To the lifetime of your children or grand children? The
        end of your nation, the dissolution of your culture, or the evolution from your species to
  ...
  {#snippet right()}
    <Description>
      ...
      <p>
        ...
        material. Much like the name on a tombstone represents the life of the body buried below,
        the association of a name to a marker represents the time scale of an individual. The
        proximity between three successive markers represents the lifetime of a family, first as a
        child and grandchild to the generations before, then as a child and parent, and finally as a
        parent and grandparent. Beyond the family, the language and alphabet represent the lifetime
  ...
  {#snippet left()}
    <Description>
      <p>
        ...
        of humans alive today, containing multitudes of branching lineages across families and
        nations and cultures. The specific nations, names, and cultures were chosen to communicate
        the idea of a longer now from the author’s perspective. The names closest to the present
        were chosen from the most popular names of their generation in the United States, intended
        to be familiar names of nieces, friends, and grandmothers. If the project were developed by
        another author, or in another culture, an entirely different set of names would be chosen to
        communicate the effect. It is not a project of separating humanity across cultures, but
        about uniting humanity across time.
      </p>
      <p>
        ...
        dug up and melted and mixed into alloys. Sand was cast into glass, concrete was discovered
        and lost and rediscovered, and oil was extracted, refined, and plasticized. Each generation
        carried the knowledge of the former until new processes and techniques unlocked materials
        with new qualities. It is an effort shared by the lifetime of the human species.
      </p>
    </Description>
  {/snippet}
  {#snippet right()}
  ...
  {#snippet right()}
    <Description>
      <p>
        ...
        on the verge of the events of the Book of Revelations for two thousand years, each
        generation convinced that they have reached the apex and can only be followed by apocalypse.
        It is more interesting to think beyond the self, to consider at the same time the concerns
        of the children, the concerns of the children’s children, the concerns of the successors
        after the fall of our nation, and the concerns of the species that evolves from our own. We
        are not the only ones on our planet and we are not the only ones in our planet’s lifetime.
      </p>
      <p>
